...
class Program
{
    static void Main(string[] args)
    {
        ...
        SayaTubeVideo videos = new SayaTubeVideo("Tutorial Design By Contract - Rizqie Ahmad Zakaria Hende");
        for (int i = 0; i < 3; i++)
        {
        ...
        try
        {
            SayaTubeVideo video = new SayaTubeVideo("Tutorial Design By Contract - Rizqie Ahmad Zakaria Hende");
